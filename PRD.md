...
| Ambiente | URL |
|---|---|
| **Frontend (Produção)** | https://funilariaapexautobody.vercel.app |
| **Backend (Produção)** | https://funilaria-apex-autobody.onrender.com |
| **Repositório** | https://github.com/MyNamesLuiz/Projeto.SAAS |
...
| Múltiplas filiais | O MVP cobre o estabelecimento principal. Suporte a filiais é candidato natural à V2. |
...
| Estado global de UI | Zustand v5 |
| Drag & Drop | dnd-kit |
| Estilo | TailwindCSS v4 + clsx |
| Roteamento | React Router v7 |
| Backend | Node.js + Fastify v5 |
| Banco de dados | SQLite / better-sqlite3 (dev) · PostgreSQL (produção) |
...
- [x] Pode ser criada via formulário com todos os campos obrigatórios
- [x] Aparece no Kanban na coluna correta
- [x] Pode ser movida via drag & drop e o novo status persiste após reload
- [x] Aparece nos números do dashboard
- [x] Pode ser encontrada pela busca por placa, nome ou telefone
- [x] Se parada há mais de 3 dias, exibe o indicador de alerta
- [x] Cada mudança de status gera um registro no histórico acessível na tela de detalhe

---

## 9. Próximos Passos (Roadmap V2)
...
*Documento atualizado em maio de 2026 — Squad 6*
