...
function Toast({ message, onDone }: { message: string; onDone: () => void }) {
  ...
  return (
    ...
    >
      ...
      <span style={{ fontFamily: 'var(--font-body)', fontSize: 'var(--text-base)', fontWeight: 500, color: 'var(--text-primary)' }}>
        {message}
      </span>
    </div>
  )
...
export default function Layout() {
  ...
  const currentUser = JSON.parse(localStorage.getItem('apex_user') ?? 'null') as
    ...
    <div className="flex h-[100dvh] overflow-hidden" style={{ background: 'var(--bg-base)' }}>
      ...
      >
        ...
        >
          ...
          <div>
            <p style={{
              fontFamily: 'var(--font-heading)', fontSize: 'var(--text-lg)', fontWeight: 800,
              letterSpacing: '0.08em', color: 'var(--text-primary)', lineHeight: 1,
            }}>
              APEX
            </p>
            <p style={{
              fontFamily: 'var(--font-heading)', fontSize: 'var(--text-2xs)', fontWeight: 600,
              letterSpacing: '0.22em', color: 'var(--text-secondary)', lineHeight: 1, marginTop: 3,
            }}>
              AUTOBODY
            </p>
          </div>
        ...
        <div className="px-2 pb-4" style={{ borderTop: '1px solid var(--border)', paddingTop: 12 }}>
          {currentUser && (
            <div className="px-4 py-2 mb-1">
              <div style={{
                ...
                fontFamily: 'var(--font-body)', letterSpacing: '0.03em', marginBottom: 2,
              }}>
                Conectado como
              </div>
              <div style={{
          ...
          >
            <svg width="18" height="18" viewBox="0 0 18 18" fill="none" aria-hidden>
              <path d="M7 9h8M12 6l3 3-3 3" stroke="var(--red)" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
              <path d="M10 3H4a1 1 0 00-1 1v10a1 1 0 001 1h6" stroke="var(--text-muted)" strokeWidth="1.5" strokeLinecap="round"/>
            </svg>
            <span style={{
              fontFamily: 'var(--font-heading)', fontSize: 'var(--text-base)', fontWeight: 700,
              letterSpacing: '0.06em', color: 'var(--red)', textTransform: 'uppercase',
            }}>
              Sair
            </span>
          </button>
        ...
        >
          ...
          <button
            ...
            style={{
              ...
              fontFamily: 'var(--font-heading)', fontSize: 'var(--text-base)', letterSpacing: '0.06em',
            }}
          >
            ...
            {({ isActive }) => (
              ...
              >
                ...
                <span style={{
                  ...
                  letterSpacing: '0.14em', textTransform: 'uppercase', color: 'inherit',
                }}>
                  {label}
                </span>
              </div>
      ...
      {showModal && (
        <NovaOSModal onClose={() => setShowModal(false)} onSuccess={handleSuccess} />
      )}
...
function NovaOSModal({ onClose, onSuccess }: { onClose: () => void; onSuccess: () => void }) {
  ...
  const canSubmit = ['cliente_nome','veiculo_placa','veiculo_modelo','descricao_servico']
  ...
  return (
    ...
    >
      <div
        className="w-full max-w-lg max-h-[90vh] overflow-y-auto rounded-xl fade-up"
      ...
      >
        ...
        >
          <h2 style={{
            fontFamily: 'var(--font-heading)', fontSize: 'var(--text-md)', fontWeight: 800,
