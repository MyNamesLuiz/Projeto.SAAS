            ...
            <div className="flex flex-col gap-3">
              ...
              {KANBAN_COLUMNS.map((col) => {
                ...
                return (
                  <button
                    key={col.id}
                    disabled={isCurrent || moveStatus.isPending}
                    ...
                    style={{
                      background: isCurrent ? `${col.accent}26` : 'var(--bg-card)',
                      border: `1px solid ${isCurrent ? col.color : 'var(--border)'}`,
                      opacity: moveStatus.isPending ? 0.6 : 1,
                      cursor: isCurrent ? 'default' : 'pointer',
                    }}>
                    <span className="w-2 h-2 rounded-full flex-shrink-0" style={{ background: col.color }} />
                    <span className="font-mono text-[11px] font-bold text-[var(--text-primary)]">{col.label}</span>
                    {isCurrent && (
